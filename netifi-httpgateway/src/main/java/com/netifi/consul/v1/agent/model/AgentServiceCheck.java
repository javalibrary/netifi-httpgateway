...
// https://github.com/hashicorp/consul/blob/v1.5.1/api/agent.go#L187
@JsonDeserialize(builder = AgentServiceCheck.Builder.class)
public class AgentServiceCheck {
  ...
  private AgentServiceCheck(Builder builder) {
  ...
  public static class Builder {
    ...
    public AgentServiceCheck build() {
      return new AgentServiceCheck(this);
    }
  }
}
